(this.wordle = this.wordle || {}),
  (this.wordle.bundle = (function (e) {
                ...
                for (
                  var t = function (t) {
                      var n = document.createElement("game-tile"),
                        a = e._letters[t];
                      (a && n.setAttribute("letter", a), e._evaluation[t]) &&
                        (n.setAttribute("evaluation", e._evaluation[t]),
                        setTimeout(function () {
              ...
              value: function () {
                ...
                this.$row &&
                  this.$tiles.forEach(function (t, n) {
                    var a = e._letters[n];
                    a
                      ? t.setAttribute("letter", a)
                      : t.removeAttribute("letter");
                  });
              },
            },
          ],
    ...
    var z = "nyt-wordle-darkmode",
      ...
      E = (function (e) {
        ...
        function n() {
          ...
          return (
            !0 === s || !1 === s ? e.setDarkTheme(s) : r && e.setDarkTheme(!0),
          ...
          r(n, [
            {
              ...
              value: function (e) {
                ...
                e && !t.classList.contains("nightmode")
                  ? t.classList.add("nightmode")
                  : t.classList.remove("nightmode"),
                  (this.isDarkTheme = e),
            ...
            },
            {
              ...
              value: function (e) {
                var t = document.querySelector("body");
                e && !t.classList.contains("colorblind")
                  ? t.classList.add("colorblind")
                  : t.classList.remove("colorblind"),
    ...
    var I =
        "object" == ("undefined" == typeof global ? "undefined" : n(global)) &&
        global &&
    ...
    function me(e, t, n) {
      ((void 0 !== n && !T(e[t], n)) || (void 0 === n && !(t in e))) &&
        he(e, t, n);
    }
    var fe,
      ye = function (e, t, n) {
      ...
      ve =
        ...
        !module.nodeType &&
        module,
      be = ve && ve.exports === ge ? q.Buffer : void 0,
    ...
    function ht(e) {
      return (function (e, t, n, a) {
        ...
        for (var r = -1, o = t.length; ++r < o; ) {
          ...
          void 0 === l && (l = e[i]), s ? he(n, i, l) : rt(n, i, l);
        }
        return n;
      })(e, pt(e));
    }
    ...
    function mt(e, t, n, a, s, r, o) {
      ...
      if (c) me(e, n, c);
          ...
          (d = l),
            h || m || f
              ? Ne(i)
                ...
                : (d = [])
              : (function (e) {
                  if (!Oe(e) || "[object Object]" != F(e)) return !1;
                  var t = Ee(e);
                  if (null === t) return !0;
                  var n = We.call(t, "constructor") && t.constructor;
                  return (
                    "function" == typeof n && n instanceof n && Ye.call(n) == Ve
                  );
                })(l) || Ae(l)
              ? ((d = i),
                Ae(i)
        ...
        p && (o.set(l, d), s(d, l, a, r, o), o.delete(l)), me(e, n, d);
      }
    }
    ...
    function ft(e, t, n, a, s) {
      e !== t &&
        ye(
          t,
          function (r, o) {
            if ((s || (s = new ue()), U(r))) mt(e, t, o, n, ft, a, s);
            else {
              var i = a ? a(at(e, o), r, o + "", e, t, s) : void 0;
              void 0 === i && (i = r), me(e, o, i);
            }
          },
          pt
        );
          ...
          return (
            ...
            function () {
              for (
                ...
                o[s] = a[t + s];
              s = -1;
              for (var i = Array(t + 1); ++s < t; ) i[s] = a[s];
              return (i[t] = n(o)), gt(e, this, i);
            }
          );
        })(e, t, yt),
        e + ""
      ...
      jt =
        ...
        St(function (e, t) {
          var a = -1,
            ...
            o = s > 2 ? t[2] : void 0;
          for (
            r = zt.length > 3 && "function" == typeof r ? (s--, r) : void 0,
              o &&
                (function (e, t, a) {
                  if (!U(a)) return !1;
                  var s = n(t);
    ...
    function Kt(e, t) {
      try {
        for (
          var n = e, a = [], s = 0, r = 0, o = " > ".length, i = void 0;
          n &&
          s++ < 5 &&
          !(
            "html" === (i = Zt(n, t)) ||
            (s > 1 && r + a.length * o + i.length >= 80)
          );

        )
          a.push(i), (r += i.length), (n = n.parentNode);
    ...
    function Zt(e, t) {
      ...
      else if ((i.id && l.push("#" + i.id), (n = i.className) && $t(n)))
        for (a = n.split(/\s+/), o = 0; o < a.length; o++) l.push("." + a[o]);
    ...
    function rn(e) {
      var t =
        "string" == typeof e
          ? (function (e) {
              var t = nn.exec(e);
              if (!t) throw new en("Invalid Sentry Dsn: " + e);
    ...
    var on,
      ln = ["fatal", "error", "warning", "log", "info", "debug", "critical"],
      cn = Nt(),
      un = "Sentry Logger ",
      dn = ["debug", "info", "warn", "error", "log", "assert"];
    ...
    function pn(e) {
      ...
      dn.forEach(function (e) {
        ...
        e in t.console && s && ((a[e] = n[e]), (n[e] = s));
      });
      try {
        return e();
      } finally {
    ...
    function _n(e) {
      try {
        return (
          (t = e),
          "undefined" != typeof Element && Xt(t, Element)
            ? Kt(e)
    ...
    function Sn(e, t) {
      ...
      if (n[0].length >= t) return mn(n[0], t);
      for (var a = n.length; a > 0; a--) {
        var s = n.slice(0, a).join(", ");
        if (!(s.length > t)) return a === n.length ? s : mn(s, t);
      }
      return "";
    }
    ...
    function zn(e) {
      ...
      if (Yt(e)) {
        ...
        try {
          for (
            var s = Lt(Object.keys(e)), r = s.next();
            !r.done;
            r = s.next()
          ) {
            var o = r.value;
    ...
    function An(e) {
      if (!Mn[e])
        switch (((Mn[e] = !0), e)) {
          case "console":
            !(function () {
              if (!("console" in Rn)) return;
              dn.forEach(function (e) {
                e in Rn.console &&
                  gn(Rn.console, e, function (t) {
                    return function () {
              ...
              Rn.document.addEventListener("click", t, !1),
                ...
                ["EventTarget", "Node"].forEach(function (t) {
                  ...
                  n &&
                    ...
                    (gn(n, "addEventListener", function (t) {
                        ...
                        if ("click" === t || "keypress" == t)
                          try {
                            ...
                            o &&
                              ((o.refCount -= 1),
                              o.refCount <= 0 &&
                                (e.call(this, t, o.handler, a),
                                (o.handler = void 0),
                                delete r[t]),
                              0 === Object.keys(r).length &&
                                delete s.__sentry_instrumentation_handlers__);
                          } catch (e) {}
          ...
          case "xhr":
            !(function () {
              if (!("XMLHttpRequest" in Rn)) return;
                ...
                return function () {
                  ...
                  return (
                    ...
                    "function" == typeof a.onreadystatechange
                      ? gn(a, "onreadystatechange", function (e) {
                          return function () {
                            for (var t = [], n = 0; n < arguments.length; n++)
                              t[n] = arguments[n];
                            return o(), e.apply(a, t);
                          };
                        })
          ...
          case "unhandledrejection":
            (Gn = Rn.onunhandledrejection),
              (Rn.onunhandledrejection = function (e) {
                return (
                  Pn("unhandledrejection", e), !Gn || Gn.apply(this, arguments)
                );
              });
            break;
          default:
    ...
    function Dn(e) {
      return (
        void 0 === e && (e = []),
        "Request" in Rn && Xt(e[0], Request) && e[0].method
    ...
    function ta(e, t, a, s, r) {
      ...
      if (
        null === t ||
        (["number", "boolean", "string"].includes(n(t)) && !Jt(t))
      )
        return t;
      var p = (function (e, t) {
        try {
          return "domain" === e && t && "object" === n(t) && t._events
            ? "[Domain]"
            : "domainEmitter" === e
            ? "[DomainEmitter]"
      ...
      if (0 === a) return p.replace("object ", "");
      ...
      return {
        ...
        add: function (a) {
          if (!(void 0 === e || t.length < e))
            return aa(
              new en("Not adding Promise due to buffer limit reached.")
            );
          var s = a();
          return (
    ...
    function ba(e, t, n) {
      return void 0 === n && (n = Date.now()), va(e, t) > n;
    }
    ...
    function ka(e, t, n) {
      ...
      if (l)
        try {
          for (
            var u = Lt(l.trim().split(",")), d = u.next();
            !d.done;
            d = u.next()
          ) {
            ...
            if (p[1])
              try {
                for (
                  var f = ((r = void 0), Lt(p[1].split(";"))), y = f.next();
                  !y.done;
                  y = f.next()
                ) {
                  i[y.value] = n + m;
    ...
    var wa = (function () {
      ...
      return (
        (e.clone = function (t) {
          ...
          return (
            t &&
              ((n._breadcrumbs = Rt(t._breadcrumbs)),
              (n._tags = Ot({}, t._tags)),
        ...
        (e.prototype.setTag = function (e, t) {
          var n;
          return (
            (this._tags = Ot(Ot({}, this._tags), (((n = {})[e] = t), n))),
            this._notifyScopeListeners(),
            this
          );
        }),
        (e.prototype.setExtras = function (e) {
          return (
            (this._extra = Ot(Ot({}, this._extra), e)),
            this._notifyScopeListeners(),
            this
          );
        }),
        (e.prototype.setExtra = function (e, t) {
          var n;
          return (
            (this._extra = Ot(Ot({}, this._extra), (((n = {})[e] = t), n))),
            this._notifyScopeListeners(),
            this
          );
        }),
        ...
        (e.prototype.update = function (t) {
          ...
          return (
            t instanceof e
              ? ((this._tags = Ot(Ot({}, this._tags), t._tags)),
        ...
        (e.prototype.addBreadcrumb = function (e, t) {
          ...
          return (
            (this._breadcrumbs = Rt(this._breadcrumbs, [a]).slice(-n)),
            this._notifyScopeListeners(),
            this
          );
        }),
        ...
        (e.prototype.applyToEvent = function (e, t) {
          if (
            (this._extra &&
              ...
              (e.extra = Ot(Ot({}, this._extra), e.extra)),
            this._tags &&
              Object.keys(this._tags).length &&
              (e.tags = Ot(Ot({}, this._tags), e.tags)),
            this._user &&
              Object.keys(this._user).length &&
              (e.user = Ot(Ot({}, this._user), e.user)),
            this._contexts &&
              Object.keys(this._contexts).length &&
              (e.contexts = Ot(Ot({}, this._contexts), e.contexts)),
        ...
        (e.prototype.setSDKProcessingMetadata = function (e) {
          return (
            (this._sdkProcessingMetadata = Ot(
              Ot({}, this._sdkProcessingMetadata),
              e
            )),
            this
          );
        ...
        (e.prototype._notifyEventProcessors = function (e, t, n, a) {
          ...
          return (
            ...
            new sa(function (r, o) {
              var i = e[a];
              if (null === t || "function" != typeof i) r(t);
              else {
                var l = i(Ot({}, t), n);
                Vt(l)
                  ? l
    ...
    function Ca() {
      var e = Ea();
      return (
        (Oa(e) && !La(e).isOlderThan(4)) || Ia(e, new ja()),
        qt()
          ? (function (e) {
              try {
                var t = Ea().__SENTRY__,
    ...
    function Ra(e) {
      for (var t = [], n = 1; n < arguments.length; n++)
        t[n - 1] = arguments[n];
      var a = Ca();
      if (a && a[e]) return a[e].apply(a, Rt(t));
      throw new Error(
        "No hub defined or " +
          e +
    ...
    function Ga(e) {
      ...
      return (
        (function (e) {
          ...
          return (
            -1 !== s.indexOf(r) &&
              a.push.apply(a, Rt(a.splice(s.indexOf(r), 1))),
            a
          );
        })(e).forEach(function (e) {
          (t[e.name] = e),
        ...
        return (
          ...
          (e.prototype.setupIntegrations = function () {
            this._isEnabled() &&
              ...
              (this._integrations = Ga(this._options));
          }),
          (e.prototype.getIntegration = function (e) {
            try {
          ...
          (e.prototype._prepareEvent = function (e, t, a) {
            ...
            var p = na(u);
            return (
              d && (p = d.applyToEvent(u, a)),
              p.then(function (e) {
                return (
                  e &&
                    (e.sdkProcessingMetadata = Ot(
                      Ot({}, e.sdkProcessingMetadata),
                      {
            ...
            return !c && "number" == typeof o && Math.random() > o
              ...
              : this._prepareEvent(e, n, t)
                  .then(function (n) {
                    ...
                    return (t && t.data && !0 === t.data.__sentry__) || c || !r
                      ? n
                      : (function (e) {
                          var t =
                  ...
                  .then(function (t) {
                    ...
                    return (
                      !c && s && a._updateSessionFromEvent(s, t),
                      a._sendEvent(t),
                      t
                    );
                  })
                  .then(null, function (e) {
                    if (e instanceof en) throw e;
                    throw (
    ...
    var Ka = (function () {
      ...
      Za = (function () {
        function e(e) {
          (this._options = e),
            this._options.dsn ||
              (Fa && on.warn("No DSN provided, backend will not do anything.")),
                          ...
                          if (e.exception)
                            try {
                              ...
                              return (
                                Fa &&
                                  on.error(
                                    "Cannot extract message for event " + Jn(e)
                                  ),
                                []
                              );
                            }
    ...
    function is(e) {
      try {
        if (e.stacktrace) return os(e.stacktrace.frames);
        var t;
        try {
        ...
        return Fa && on.error("Cannot extract url for event " + Jn(e)), null;
      }
    }
    var ls = "?";
    ...
    function cs(e, t, n, a) {
      ...
      return void 0 !== n && (s.lineno = n), void 0 !== a && (s.colno = a), s;
    }
    var us =
      ...
      gs = [
        ...
        function (e) {
          var t = ys.exec(e);
          return t
            ? cs(t[2], t[1] || ls, +t[3], t[4] ? +t[4] : void 0)
            : void 0;
        },
      ],
    ...
    function Ts(e, t, n, a) {
      var s;
      if (Ft(e) && e.error) return Ss(e.error);
      if (Ut(e) || Bt(e, "DOMException")) {
        var r = e;
        if ("stack" in e) s = Ss(e);
        else {
    ...
    function Rs() {
      if (Os) return Os;
      if (On(Is.fetch)) return (Os = Is.fetch.bind(Is));
      var e = Is.document,
        t = Is.fetch;
        ...
        function e(e) {
          ...
          (this.options = e),
            ...
            this.options.sendClientReports &&
              Ms.document &&
              Ms.document.addEventListener("visibilitychange", function () {
          ...
          (e.prototype._flushOutcomes = function () {
            if (this.options.sendClientReports) {
              ...
              if (((this._outcomes = {}), Object.keys(e).length)) {
                Ls &&
                  on.log("Flushing outcomes:\n" + JSON.stringify(e, null, 2));
                var t,
                  n,
                  a,
                  s = Ba(this._api.dsn, this._api.tunnel),
                  ...
                  o =
                    ((t = r),
                    ya(
                      (n = this._api.tunnel && an(this._api.dsn))
                        ? {
                            dsn: n,
                          }
                        : {},
                ...
                try {
                  !(function (e, t) {
                    if (
                      "[object Navigator]" ===
                        Object.prototype.toString.call(Is && Is.navigator) &&
                      "function" == typeof Is.navigator.sendBeacon
                    )
              ...
              } else Ls && on.log("No outcomes to flush");
            }
          }),
          ...
          (t.prototype._sendRequest = function (e, t) {
            ...
            return (
              void 0 !== this.options.fetchParameters &&
                Object.assign(a, this.options.fetchParameters),
              void 0 !== this.options.headers &&
                (a.headers = this.options.headers),
              this._buffer
                .add(function () {
                  return new sa(function (t, s) {
                    n._fetch(e.url, a)
                      .then(function (a) {
                        var r = {
                          "x-sentry-rate-limits": a.headers.get(
                    ...
                    return new sa(function (t, a) {
                      ...
                      n.options.headers))
                        Object.prototype.hasOwnProperty.call(
                          n.options.headers,
                          r
                        ) && s.setRequestHeader(r, n.options.headers[r]);
                      s.send(e.body);
                    });
                  })
                  .then(void 0, function (t) {
    ...
    var Ds = (function (e) {
        ...
        return (
          ...
          (t.prototype._setupTransport = function () {
            ...
            var t,
              n,
              a = Ot(Ot({}, this._options.transportOptions), {
                dsn: this._options.dsn,
                tunnel: this._options.tunnel,
                sendClientReports: this._options.sendClientReports,
                _metadata: this._options._metadata,
              }),
              s = Aa(a.dsn, a._metadata, a.tunnel),
              r = Ba(s.dsn, s.tunnel);
            if (this._options.transport) return new this._options.transport(a);
            if (Cn()) {
    ...
    function $s(e, t, n) {
          ...
          throw (
            ...
            Ma(function (n) {
              n.addEventProcessor(function (e) {
                return (
                  t.mechanism && (Xn(e, void 0, void 0), Kn(e, t.mechanism)),
      ...
      bn(s, e), vn(e, "__sentry_wrapped__", s);
      try {
      ...
      if ((void 0 === e && (e = {}), Hs.document))
        if (e.eventId)
          if (e.dsn) {
                ...
                for (var r in t)
                  if ("dsn" !== r)
                    if ("user" === r) {
                      if (!t.user) continue;
                      t.user.name &&
                        (s += "&name=" + encodeURIComponent(t.user.name)),
                        t.user.email &&
                          (s += "&email=" + encodeURIComponent(t.user.email));
                    } else
                      s +=
                        "&" +
            ...
            n && n.appendChild(t);
          } else Ls && on.error("Missing dsn option in showReportDialog call");
        else Ls && on.error("Missing eventId option in showReportDialog call");
    }
    var Ys = (function () {
      function e(t) {
        (this.name = e.id),
          ...
          if (!(Fs() || (l && l.__sentry_own_request__))) {
            var c =
              void 0 === l && $t(s)
                ...
                : Js(Ts(l || s, void 0, a, !1), r, o, i);
            (c.level = Ct.Error), Xs(n, l, c, "onerror");
          }
        }
      });
    }
    ...
    function Vs() {
      Nn("unhandledrejection", function (e) {
        ...
        if (n.getIntegration(Ys)) {
          ...
          if (Fs() || (s && s.__sentry_own_request__)) return !0;
          var r = Gt(s)
            ? {
                exception: {
                  values: [
            ...
            : Ts(s, void 0, a, !0);
          (r.level = Ct.Error), Xs(n, s, r, "onunhandledrejection");
        }
      });
    }
          ...
          (e.prototype.setupOnce = function () {
            ...
            this._options.setTimeout && gn(e, "setTimeout", er),
              ...
              this._options.requestAnimationFrame &&
                gn(e, "requestAnimationFrame", tr),
              this._options.XMLHttpRequest &&
                "XMLHttpRequest" in e &&
                gn(XMLHttpRequest.prototype, "send", nr);
            ...
            e in a &&
              ...
              gn(a, e, function (t) {
                var n = {
                  ...
                  a = kn(t);
                return a && (n.mechanism.data.handler = Tn(a)), $s(t, n);
              });
          }),
          e.apply(this, t)
        );
          ...
          return function (n, a, s) {
            try {
              "function" == typeof a.handleEvent &&
                (a.handleEvent = $s(a.handleEvent.bind(a), {
                  mechanism: {
                    data: {
            ...
            this._options.dom &&
              Nn(
                ...
                (function (e) {
                  function t(t) {
                    var a,
                      s = "object" === n(e) ? e.serializeAttribute : void 0;
                    "string" == typeof s && (s = [s]);
                    try {
                      a = t.event.target
                        ? Kt(t.event.target, s)
    ...
    function rr(e) {
      ...
      if ("assert" === e.level) {
        ...
        (t.message =
          "Assertion failed: " +
          (fn(e.args.slice(1), " ") || "console.assert")),
              ...
              ? (function (e, t, n, a) {
                  if (
                    !(
                      ...
                      n.exception.values &&
                      a &&
                      Xt(a.originalException, Error)
                    )
                  )
                    return n;
                  var s = ur(t, a.originalException, e);
                  return (n.exception.values = Rt(s, n.exception.values)), n;
                })(a._key, a._limit, t, n)
              : t;
          });
        }),
    ...
    function ur(e, t, n, a) {
      if ((void 0 === a && (a = []), !Xt(t[n], Error) || a.length + 1 >= e))
        return a;
      var s = xs(t[n]);
          ...
          (e.prototype.setupOnce = function () {
            xa(function (t) {
              if (Ca().getIntegration(e)) {
                if (!dr.navigator && !dr.location && !dr.document) return t;
                var n =
                    (t.request && t.request.url) ||
                    (dr.location && dr.location.href),
                  a = (dr.document || {}).referrer,
                  s = (dr.navigator || {}).userAgent,
                  r = Ot(
                    Ot(
                      Ot({}, t.request && t.request.headers),
                      a && {
                        Referer: a,
                      }
                    ),
    ...
    function mr(e, t) {
      ...
      if (!n && !a) return !0;
      if ((n && !a) || (!n && a)) return !1;
      if (((n = n), (a = a).length !== n.length)) return !1;
    ...
    function jr() {
      ...
      if (e) {
        ...
        _r &&
          on.log("[Tracing] Transaction: " + t + " -> Global error occured"),
          e.setStatus(t);
      }
    }
    var Er = "finishReason",
          ...
          (t.prototype.finish = function (t) {
            ...
            if (void 0 === this.endTimestamp) {
              if (
                ...
                this._trimEnd &&
                  a.length > 0 &&
                  (this.endTimestamp = a.reduce(function (e, t) {
              ...
              o &&
                o.recordLostEvent &&
                o.recordLostEvent("sample_rate", "transaction");
            }
          }),
        ...
        (function () {
          ...
          return (
            ...
            (e.prototype.setTag = function (e, t) {
              var n;
              return (
                (this.tags = Ot(Ot({}, this.tags), (((n = {})[e] = t), n))),
                this
              );
            }),
            (e.prototype.setData = function (e, t) {
              var n;
              return (
                (this.data = Ot(Ot({}, this.data), (((n = {})[e] = t), n))),
                this
              );
            }),
            ...
            (e.prototype.updateWithContext = function (e) {
              ...
              return (
                ...
                (this.startTimestamp =
                  null != (a = e.startTimestamp) ? a : this.startTimestamp),
        ...
        function t(t, n, a, s) {
          ...
          return (
            ...
            n &&
              ...
              _r &&
                on.log(
                  "Setting idle transaction on scope. Span ID: " + r.spanId
                ),
        ...
        return (
          ...
          (t.prototype.finish = function (t) {
            ...
            if (
              ...
              try {
                for (
                  var r = Lt(this._beforeFinishCallbacks), o = r.next();
                  !o.done;
                  o = r.next()
                ) {
                  (0, o.value)(this, t);
            ...
            } else _r && on.log("[Tracing] No active IdleTransaction");
            return (
              this._onScope && Rr(this._idleHub),
              e.prototype.finish.call(this, t)
            );
          }),
          ...
          (t.prototype._popActivity = function (e) {
            ...
            if (
              (this.activities[e] &&
                (_r && on.log("[Tracing] popActivity " + e),
              ...
              var n = this._idleTimeout,
                a = ha() + n / 1e3;
              setTimeout(function () {
                t._finished || (t.setTag(Er, Tr[1]), t.finish(a));
              }, n);
            }
          }),
    ...
    function Nr() {
      ...
      if (e.__SENTRY__) {
        ...
        n.length > 0 &&
          (e.__SENTRY__.integrations = Rt(e.__SENTRY__.integrations || [], n));
      }
    }
    var Pr = Nt();
    var Dr = function (e, t, n) {
        ...
        return function (s) {
          t.value >= 0 &&
            (s || n) &&
            ((t.delta = t.value - (a || 0)),
            (t.delta || void 0 === a) && ((a = t.value), e(t)));
        };
      },
      Hr = function (e, t) {
        return {
      ...
      Fr = function (e, t) {
        var n = function n(a) {
          ("pagehide" !== a.type &&
            "hidden" !== Nt().document.visibilityState) ||
            (e(a),
            t &&
      ...
      $r = function () {
        return (
          Ur < 0 &&
            ((Ur = "hidden" === Nt().document.visibilityState ? 0 : 1 / 0),
            Fr(function (e) {
              var t = e.timeStamp;
              Ur = t;
            }, !0)),
        ...
        function e(e) {
          void 0 === e && (e = !1),
            ...
            !qt() &&
              ...
              Yr.document &&
              (Yr.performance.mark &&
                Yr.performance.mark("sentry-tracing-init"),
              this._trackCLS(),
              this._trackLCP(),
              this._trackFID());
        }
        return (
          (e.prototype.addPerformanceEntries = function (e) {
            ...
            if (Yr && Yr.performance && Yr.performance.getEntries && ma) {
              ...
              if (
                    ...
                    if (!("navigation" === e.op && s + o < e.startTimestamp))
                      switch (r.entryType) {
                        ...
                        case "measure":
                          ...
                          "first-paint" === r.name &&
                            u &&
                            (_r && on.log("[Measurements] Adding FP"),
                            (t._measurements.fp = {
                              value: r.startTime,
                            }),
                            ...
                            "first-contentful-paint" === r.name &&
                              u &&
                              (_r && on.log("[Measurements] Adding FCP"),
                              (t._measurements.fcp = {
                                value: r.startTime,
                              }),
                        ...
                        case "resource":
                          ...
                          !(function (e, t, n, a, s, r) {
                            ...
                            var o = {};
                            "transferSize" in t &&
                              (o["Transfer Size"] = t.transferSize);
                            "encodedBodySize" in t &&
                              (o["Encoded Body Size"] = t.encodedBodySize);
                            "decodedBodySize" in t &&
                              (o["Decoded Body Size"] = t.decodedBodySize);
                            var i = r + a;
                            Jr(e, {
                              description: n,
                              endTimestamp: i + s,
                ...
                var r = zr(ma);
                "number" == typeof n &&
                  (_r && on.log("[Measurements] Adding TTFB"),
                  ...
                  this._measurements["mark.fid"] &&
                    ...
                    Jr(e, {
                      ...
                      endTimestamp:
                        ...
                        zr(this._measurements.fid.value),
                      op: "web.vitals",
                  ...
                  (function (e, t, n) {
                    t &&
                      (_r && on.log("[Measurements] Adding LCP Data"),
                    ...
                    n &&
                      n.sources &&
                      (_r && on.log("[Measurements] Adding CLS Data"),
          ...
          (e.prototype._trackCLS = function () {
            ...
            (e = function (e) {
              var t = e.entries.pop();
              t &&
                (_r && on.log("[Measurements] Adding CLS"),
                (l._measurements.cls = {
                  value: e.value,
                }),
                (l._clsEntry = t));
                ...
                (o = function (e) {
                  if (e && !e.hadRecentInput) {
                    ...
                    e.startTime - t.startTime < 5e3
                      ? ((s += e.value), r.push(e))
                      : ((s = e.value), (r = [e])),
                      s > a.value && ((a.value = s), (a.entries = r), n && n());
                  }
                })
              )) &&
                ((n = Dr(e, a, t)),
                Fr(function () {
                  i.takeRecords().map(o), n(!0);
                }));
          }),
          (e.prototype._trackLCP = function () {
            ...
            !(function (e, t) {
              var n,
                ...
                r = function (e) {
                  var t = e.startTime;
                  t < a.firstHiddenTime && ((s.value = t), s.entries.push(e)),
                    n && n();
                },
    ...
    function Zr(e) {
      ...
      n &&
        Nn("fetch", function (e) {
          !(function (e, t, n) {
            if (!xr() || !e.fetchData || !t(e.fetchData.url)) return;
            if (e.endTimestamp) {
            ...
            if (s) {
              ...
              Xt(o, Request) && (l = o.headers),
                l
                  ? "function" == typeof l.append
                    ? l.append("sentry-trace", r.toTraceparent())
                    : (l = Array.isArray(l)
                        ? Rt(l, [["sentry-trace", r.toTraceparent()]])
                        : Ot(Ot({}, l), {
          ...
          Nn("xhr", function (e) {
            !(function (e, t, n) {
              ...
              if (e.endTimestamp) {
                ...
                return void (
                  (o = n[s]) &&
                  (o.setHttpStatus(a.status_code), o.finish(), delete n[s])
                );
              }
              var r = Sr();
              if (r) {
          ...
          routingInstrumentation: function (e, t, n) {
            if (
              ...
              t &&
                ...
                n &&
                  Nn("history", function (t) {
                    var n = t.to,
                      r = t.from;
                    void 0 === r && s && -1 !== s.indexOf(n)
                      ? (s = void 0)
                      : r !== n &&
                        ((s = void 0),
                        a &&
          ...
          (e.prototype._createRouteTransaction = function (e) {
            ...
            if (this._getCurrentHub) {
              ...
              !1 === c.sampled &&
                ...
                _r &&
                  on.log(
                    "[Tracing] Starting " + c.op + " transaction on scope"
                  );
              ...
              return (
                u.registerBeforeFinishCallback(function (e, n) {
    ...
    (eo = Ea()).__SENTRY__ &&
      ((eo.__SENTRY__.extensions = eo.__SENTRY__.extensions || {}),
      eo.__SENTRY__.extensions.startTransaction ||
        (eo.__SENTRY__.extensions.startTransaction = Ar),
      eo.__SENTRY__.extensions.traceHeaders ||
        (eo.__SENTRY__.extensions.traceHeaders = qr)),
      qt() && Nr(),
      Nn("error", jr),
    ...
    var so = {
        ...
        integrations: [new ao()],
        release:
          (null === (to = window.wordle) || void 0 === to ? void 0 : to.hash) ||
          "",
    ...
    function po() {
      ...
      return e.match(/chrome|chromium|crios/i)
        ? "chrome"
    ...
    yo.innerHTML =
      '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">High Contrast Mode</div>\n          <div class="description">For improved color vision</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback</div>\n        </div>\n        <div class="control">\n          <a href="'
        ...
        .concat(
          ...
          ' The New York Times Company</div>\n    <div>\n      <div id="puzzle-number"></div>\n    </div>\n  </div>\n'
        );
    var go = (function (e) {
      i(n, e);
      var t = f(n);
    ...
    function No(e) {
      ...
      t
        ? ((s.guesses[a] += 1),
          n ? (s.currentStreak += 1) : (s.currentStreak = 1))
        : ((s.currentStreak = 0), (s.guesses.fail += 1)),
        (s.maxStreak = Math.max(s.currentStreak, s.maxStreak)),
        (s.gamesPlayed += 1),
        (s.gamesWon += t ? 1 : 0),
        (s.winPercentage = Math.round((s.gamesWon / s.gamesPlayed) * 100)),
        (s.averageGuesses = Math.round(
          Object.entries(s.guesses).reduce(function (e, t) {
            var n = y(t, 2),
              a = n[0],
              s = n[1];
            return a !== qo ? (e += a * s) : e;
    ...
    var Po,
      Do = "nyt-wordle-refresh",
      Ho = window.localStorage;
      ...
      Zo = (function (e) {
        ...
        function n() {
          ...
          return (
            ...
            !e.lastPlayedTs || Co(new Date(e.lastPlayedTs), e.today) >= 1
          ...
          r(n, [
            {
              ...
              value: function () {
                if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                  ...
                  if (((e = n), !wo.includes(e) && !ko.includes(e)))
                    return (
                        ...
                        for (var a = 0; a < n.length; a++)
                          if (n[a] === xo && e[a] !== t[a])
                            return {
                              validGuess: !1,
                              errorMessage: ""
                                .concat(Eo(a + 1), " letter must be ")
                                .concat(t[a].toUpperCase()),
                            };
                        for (var s = {}, r = 0; r < n.length; r++)
                          [xo, _o].includes(n[r]) &&
                            (s[t[r]] ? (s[t[r]] += 1) : (s[t[r]] = 1));
                  ...
                  var o = (function (e, t) {
                    for (
                      var n = Array(t.length).fill(So),
                        a = Array(t.length).fill(!0),
                        s = Array(t.length).fill(!0),
                        r = 0;
                      r < e.length;
                      r++
                    )
                  ...
                  if (i || l)
                    No({
                      ...
                      isStreak:
                        ...
                        1 === Co(new Date(this.lastCompletedTs), new Date()),
                ...
                a.setAttribute("text", e),
                  ...
                  n
                    ? this.shadowRoot
                        ...
                        .prepend(a)
                    : this.shadowRoot.querySelector("#game-toaster").prepend(a);
              },
            },
            {
              key: "sizeBoard",
            ...
            },
            {
              ...
              value: function () {
                ...
                this.gameStatus === Jo &&
                  this.rowIndex <= 6 &&
                  t.setAttribute("highlight-guess", this.rowIndex),
                  (t.gameApp = this),
                  e.appendChild(t),
                  e.setAttribute("open", "");
              },
              ...
              value: function () {
                ...
                this.$game.addEventListener("game-key-press", function (e) {
                  ...
                  "←" === t || "Backspace" === t
                    ...
                    : "↵" === t || "Enter" === t
                    ? c.submitGuess()
                    : Io.includes(t.toLowerCase()) &&
                      c.addLetter(t.toLowerCase());
                }),
                  this.$game.addEventListener(
                    ...
                    function (e) {
                      ...
                      var t =
                        c.$board.querySelectorAll("game-row")[c.rowIndex - 1];
                      (e.path || (e.composedPath && e.composedPath())).includes(
                        t
                      ) &&
                        ([Jo, Xo].includes(c.gameStatus) &&
                          (c.restoringFromLocalStorage
                            ? c.showStatsModal()
                            : (c.gameStatus === Jo &&
                                (t.setAttribute("win", ""),
                                c.addToast(Ko[c.rowIndex - 1], 2e3)),
                              c.gameStatus === Xo &&
                                c.addToast(c.solution.toUpperCase(), 1 / 0),
                              setTimeout(function () {
                                c.showStatsModal();
                              }, 2500))),
                  ...
                  (i = {
                    ...
                    prdstring:
                      "&gtm_auth=tfAzqo1rYDLgYhmTnSjPqw&gtm_preview=env-130",
                    devstring:
                      "&gtm_auth=WiJyA7zv1sohHCWSZ3mF1Q&gtm_preview=env-8",
                    stgstring:
                      "&gtm_auth=FOuAsPhG-4kWeLk6Kq5AzQ&gtm_preview=env-7",
                    dataLayer: "",
                    modifier: "",
                    env:
                      document.location.host.indexOf(".dev.") > -1
                        ...
                        : document.location.host.indexOf(".stg.") > -1 ||
                          document.location.host.indexOf(".stage.") > -1
                        ? "stg"
                        : "prod",
                  }),
                  (l = {
                  ...
                  "dev" === i.env
                    ? (i.modifier = i.devstring)
                    : "stg" === i.env && (i.modifier = i.stgstring),
                  (function (e, t, n, a, s, r) {
                    (e[a] = e[a] || []),
                      e[a].push({
                  ...
                  (t = i.env),
                  (a =
                    t && "prod" === t ? "a.nytimes.com" : "a.dev.nytimes.com"),
              ...
              value: function () {
                ...
                this.shadowRoot.appendChild(ti.content.cloneNode(!0)),
                  ...
                  this.$keyboard.addEventListener("click", function (t) {
                    ...
                    n &&
                      e.$keyboard.contains(n) &&
                      e.dispatchKeyPressEvent(n.dataset.key);
                  }),
                  window.addEventListener("keydown", function (t) {
                    if (!0 !== t.repeat) {
                      ...
                      a ||
                        s ||
                        ((Io.includes(n.toLowerCase()) ||
                          "Backspace" === n ||
                          "Enter" === n) &&
                          e.dispatchKeyPressEvent(n));
                    }
                  }),
                      ...
                      t.forEach(function (e) {
                        ...
                        if ((e >= "a" && e <= "z") || "←" === e || "↵" === e) {
                          ...
                          "↵" == e &&
                            ((t.textContent = "enter"),
                            t.classList.add("one-and-a-half"));
                        } else (t = ai.content.cloneNode(!0).firstElementChild).classList.add(1 === e.length ? "half" : "one");
                        n.appendChild(t);
                      }),
            ...
            },
            {
              ...
              value: function () {
                for (var e in this._letterEvaluations) {
                  var t = this.$keyboard.querySelector(
                    '[data-key="'.concat(e, '"]')
                  );
    ...
    var li,
      ...
      ui,
      di,
      pi = "undefined" == typeof navigator ? void 0 : navigator,
      hi = null == pi ? void 0 : pi.clipboard;
    null === (li = null == hi ? void 0 : hi.read) ||
      void 0 === li ||
      li.bind(hi),
      null === (ci = null == hi ? void 0 : hi.readText) ||
        void 0 === ci ||
        ci.bind(hi);
    var mi =
        (null === (ui = null == hi ? void 0 : hi.write) ||
          void 0 === ui ||
          ui.bind(hi),
        null === (di = null == hi ? void 0 : hi.writeText) || void 0 === di
          ? void 0
          : di.bind(hi)),
        ...
        return ii(this, function (n) {
          if (
            ...
            "undefined" == typeof ClipboardEvent &&
              void 0 !== yi.clipboardData &&
              void 0 !== yi.clipboardData.setData)
          ) {
            if (!t) throw new Error("No `text/plain` value was specified.");
            if (((a = e["text/plain"]), yi.clipboardData.setData("Text", a)))
              return [2, !0];
            throw new Error(
          ...
          r(n, [
            {
              ...
              value: function () {
                ...
                if (
                  (a.appendChild(Ci.content.cloneNode(!0)),
                  ...
                  for (
                    var o = 1;
                    o < Object.keys(this.stats.guesses).length;
                    o++
                  ) {
                    var i = o,
      ...
      Ri = [
        ...
        .map(function (e) {
          return "\n    <a href="
            ...
            .concat(
              e.backgroundImage,
              '; background-size: 20px;"class="nav-icon"></span>\n          '
            )
            .concat(e.name, " \n      </div>\n    </a>\n    ");
        })
        .join(""),
        ...
        r(n, [
          {
            ...
            value: function () {
              ...
              this.shadowRoot.appendChild(Ai.content.cloneNode(!0)),
                this.addEventListener("click", function (t) {
                  e.shadowRoot
                    .querySelector(".content-nav")
                    .classList.add("closing-nav");
                }),
                this.shadowRoot.addEventListener("animationend", function (t) {
                  "SlideLeft" === t.animationName &&
                    (e.shadowRoot
                      .querySelector(".content-nav")
                      .classList.remove("closing-nav"),
                    e.removeChild(e.firstChild),
                    e.removeAttribute("open"));
                });
            },
